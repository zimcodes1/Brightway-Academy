...
export default function LandingPage() {
	...
	const programs = [
		{
			icon: Home,
			title: "Pre-School & Nursery",
			description:
				"Foundational learning through play, numeracy, and social development.",
		},
		{
			icon: BookOpen,
			title: "Basic School",
			description:
				"Focus on literacy and building self-confidence through a balanced curriculum.",
		},
		{
			icon: Trophy,
			title: "Secondary School",
			description:
				"Advanced academics with an emphasis on discipline and preparation for higher education.",
		},
	];
	...
	const features = [
		{
			...
			description:
				"We nurture compassionate, confident, independent, and multi-skilled lifelong learners.",
		},
		{
			icon: BookOpen,
			title: "Academic Excellence",
			description:
				"Core focus on literacy and numeracy with character development.",
		},
		{
			icon: Home,
			title: "Boarding System",
			description:
				"Efficient, well-ventilated boarding system fostering community and structured living.",
		},
		{
			icon: Trophy,
			title: "House System",
			description:
				"Named after local heritage sites: Emir of Keffi, Karu, Nasarawa, and Toto.",
		},
	];
	...
	const contactDetails = [
		...
		{ icon: Phone, text: "+234 802 848 2807" },
		{ icon: Phone, text: "+234 818 252 8897" },
	...
	return (
		<div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
					...
					<div className="grid md:grid-cols-2 gap-8">
						...
						>
							...
							<p className="text-gray-600 text-lg">
								To spread knowledge and sustain the educational well-being of
								society.
							</p>
						</motion.div>
						<motion.div
						...
						>
							...
							<p className="text-gray-600 text-lg">
								To positively affect lives and improve Nigeria through the
			...
			<section
				id="features"
				className="w-full bg-gradient-to-br from-gray-50 to-indigo-50 py-12 md:py-16"
			>
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<AnimatedSection>
						<h2 className="text-3xl md:text-4xl font-bold text-gray-800 text-center mb-12">
